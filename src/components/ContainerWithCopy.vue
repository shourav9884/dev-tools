<template>
    <h3 class="block font-semibold mb-2">{{ title }}:</h3>
    <div class="relative bg-gray-50 rounded-lg dark:bg-gray-700 p-4" :class="height">
        <div class="overflow-scroll max-h-full">
            <pre v-if="outputText"><code>{{ outputText }}</code></pre>
        </div>
        <div class="absolute top-2 end-2 bg-gray-50 dark:bg-gray-700">
            <button @click="copyText" class="text-gray-900 dark:text-gray-400 m-0.5 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 rounded-lg py-2 px-2.5 inline-flex items-center justify-center bg-white border-gray-200 border">
